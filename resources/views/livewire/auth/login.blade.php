...
<div>
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10 mx-4">
            ...
            <form wire:submit.prevent="authenticate">
                <div>
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="email_or_username" id="email" name="email" type="text" required autofocus
